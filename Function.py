#These Functions are the build ups for the game. It will search for Continuos 'X' or 'O' in column,row and digonals.
...
def check_ai_row(a,b,c):
    k=[a,b,c]
    for i in k: #k has been assigned for ease and not writing combination for every a,b or c.
